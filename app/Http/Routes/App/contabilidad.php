...
use App\Models\Contabilidad\ArchivosXMLError;
use App\Models\Contabilidad\ArchivosXML;
use App\Models\Contabilidad\XmlConceptos;
use App\Models\Contabilidad\ImpuestosLocales;


Route::group(['prefix' => 'api_cont','namespace' => 'Contabilidad','middleware' => ['auth', 'roles'],'roles' => ['administrador']], function(){
	...
	Route::get('info_productos/{id}','ProductosController@info');
	Route::get('info_pacientes/{id}','PacientesController@info');
	Route::get('info_proveedor/{id}','ProveedoresController@info');
	Route::get('info_empleados/{id}','EmpleadosController@info');
	Route::get('info_clientes/{id}','ClientesController@info');	
