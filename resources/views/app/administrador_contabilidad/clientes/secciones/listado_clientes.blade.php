...
<!--  DATO NUEVO -->
<form action="/api_cont/clientes/" id="frmNuevoDato" method="POST" class="smart-form" style="display:none;">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form class="" id="frmEditarDatos">
					<input type="hidden" name="id" id="edt_idcliente">
					<fieldset>
						<div class="row">		
							<div class="col-sm-12">
...
<script type="text/javascript">
	_g.dao = {
		...
		getModificarDatos :function(id){
					$.ajax({
						url: '/api_cont/info_clientes/'+id,
						type: 'GET',
						dataType: 'json',			
					}).done(function(data){
						_g.dao.getLimpiarDatos();
						$('#edt_idcliente').val(id);
		...
		var functionOperacionesForm = function() {
				...
				$('#btnAceptarEditar').on('click',function (e){
					e.preventDefault();
					if($("#frmEditarDatos").valid() == true && $("#edt_idcliente").val() != ''){
						$.ajax({
							url: '/api_cont/clientes/'+$("#edt_idcliente").val(),
