			...
			<div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false">
				<header>
					...
					<ul id="widget-tab-parametrizacion" class="nav nav-tabs pull-right">
						<li class="active">
							<a data-toggle="tab" href="#clientes" id="btnMEmpresas"> <i class="fa fa-users"></i> <span class="hidden-mobile hidden-tablet">General</span> </a>
						</li>
						<li>
						...
						<li>
							<a data-toggle="tab" href="#CuentasBancarias" id="btnMCuentasBancarias"> <i class="fa fa-bullseye"></i> <span class="hidden-mobile hidden-tablet">Asignaci&oacute;n Centros</span></a>
						</li>
						<li>
							<a data-toggle="tab" href="#CuentasBancarias" id="btnMCuentasBancarias"> <i class="fa fa-male"></i> <span class="hidden-mobile hidden-tablet">Cliente Comercial</span></a>
						</li>
						<li>
							<a data-toggle="tab" href="#CuentasBancarias" id="btnMCuentasBancarias"> <i class="fa fa-share-alt"></i> <span class="hidden-mobile hidden-tablet">Conexi&oacute;n Online</span></a>
						</li>
					</ul>
					<!-- // MENU INDEX CLIENTES-->
				</header>
				...
				<div>
					...
					<div class="widget-body no-padding">
						<div class="tab-content">
							<div class="tab-pane fade in active fuelux" id="clientes">
								@include('app.administrador_contabilidad.clientes.secciones.listado_clientes')
							</div>
