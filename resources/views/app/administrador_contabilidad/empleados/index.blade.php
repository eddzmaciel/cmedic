			...
			<div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false" data-widget-colorbutton="false" data-widget-deletebutton="false">
				<header>
					...
					<ul id="widget-tab-parametrizacion" class="nav nav-tabs pull-right">
						...
						<li>
							<a data-toggle="tab" href="#sucursales" id="btnMCuentasBancarias"> <i class="fa fa-bank"></i> <span class="hidden-mobile hidden-tablet">Sucursales </span></a>
						</li>
						<!--
						<li>
					...
					<div class="widget-body no-padding">
						<div class="tab-content">
							<div class="tab-pane fade in active fuelux" id="empleados">
								@include('app.administrador_contabilidad.empleados.secciones.listado_empleados')
							</div>
