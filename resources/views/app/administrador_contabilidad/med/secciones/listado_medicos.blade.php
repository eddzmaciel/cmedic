...
<!--  DATO NUEVO -->
<form action="/api_cont/medicos/" id="frmNuevoDato" method="POST" class="smart-form" style="display:none;">
		...
		var functionOperacionesForm = function() {
				...
				$('#btnAceptarEditar').on('click',function (e){
					...
					if($("#frmEditarDatos").valid() == true && $("#inpt1").val() != ''){
						$.ajax({
							url: '/api_cont/medicos/'+$("#inpt1").val(),
