  ...
  <body>
    <header class="clearfix" style="padding-bottom:15px;">
      ...
      <table border="0" cellspacing="0" cellpadding="0" >
        ...
        <tbody>
            <tr>
              <td class="no">{{ $cantidades['numero_cuenta_destino'] }}</td>
              <td class="desc">{{ $cantidades['nombre_cuenta_destino'] }}</td>
              <td class="unit">$0.00</td>
              <td class="qty">${{ $cantidades['importe'] }}</td>
            </tr>
            <tr>
              <td class="no">{{ $cantidades['numero_cuenta_origen'] }}</td>
              <td class="desc">{{ $cantidades['nombre_cuenta_origen'] }}</td>
              <td class="unit">${{ $cantidades['importe'] }}</td>
        ...
        <tfoot>
          ...
          <tr>
            <td colspan="2"></td>
            <td colspan="1">${{ (FLOAT)$cantidades['importe'] }}</td>
            <td> ${{ (FLOAT)$cantidades['importe']  }}</td>
          </tr>          
        </tfoot>
      </table>      
    <footer>
