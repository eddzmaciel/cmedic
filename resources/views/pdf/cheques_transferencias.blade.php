      ...
      <table border="0" cellspacing="0" cellpadding="0" >
        ...
        <tbody>
            ...
            <tr>
              ...
              <td class="unit">${{ $cantidades['pb_anticipo_xml'] }}</td>
              @else
        ...
        <tfoot>
          ...
          <tr>
            <td colspan="2"></td>
             @if($cantidades['pb_anticipo'])
              <td colspan="1">${{ (FLOAT)$cantidades['pb_anticipo_xml']+(FLOAT)$cantidades['pb_anticipo']->debe+(FLOAT)$cantidades['pb_total_debe_impuestos']  }}</td>
              <td> ${{ (FLOAT)$cantidades['cuenta_banco']+(FLOAT)$cantidades['pb_anticipo']->haber+(FLOAT)$cantidades['pb_total_haber_impuestos']  }}</td>
            @else
              <td colspan="1">${{ (FLOAT)$cantidades['pb_anticipo_xml']+(FLOAT)$cantidades['pb_total_debe_impuestos']  }}</td>
              <td> ${{ (FLOAT)$cantidades['cuenta_banco']+(FLOAT)$cantidades['pb_total_haber_impuestos']  }}</td>            
            @endIf
          </tr>          
        </tfoot>
      </table>
